...
- **Integraciones:** API REST (DIO/http).
...
- **Desarrollo de SereniFlu (Wellness MVP):** Diseñé una arquitectura limpia (Clean Arquitecture) modular desacoplada mediante interfaces, permitiendo el intercambio de backend en tiempo real mediante configuración.
...
- Mejora del rendimiento de carga en un **40%** mediante la implementación de Server-Side Rendering (SSR) en Next.js.
- Desarrollo de más de 8 interfaces críticas optimizadas para alta concurrencia y múltiples dispositivos.
- Establecimiento de guías de estilo y mejores prácticas de frontend, aumentando la mantenibilidad del código en un 25%.

### Desarrollador Frontend y Móvil | No Country
**Remoto | enero 2023 - enero 2025**

- Lideré el desarrollo de más de 7 soluciones multiplataforma utilizando React, TypeScript y Flutter.
...
- **Stack:** Flutter, FPdart, Supabase, PostgreSQL, Clean Architecture.
- **Logro:** Check-in emocional en <30 segundos y Posterior recomendaciones basado en estado emocional.
